const coffeeData = {
    ol: [
        ...
        { sku: '7052.80', name: '아르페지오 엑스트라', properties: [4, 4] },
        { sku: '7831.40', name: '카프리치오', properties: [-3, 2] },
        { sku: '7588.40', name: '코지', properties: [-4, 3] },
        { sku: '7884.80', name: '인디아', properties: [4, -4] },
        { sku: '7883.80', name: '프레도 인텐소', properties: [-2, 2] },
        { sku: '7854.80', name: '바닐라향* 커피', properties: [-4, -4] },
        { sku: '7864.80', name: '볼루토 디카페나토', properties: [-4, 2] },
        { sku: '7871.80', name: '코르토', properties: [5, -4] },
        { sku: '7865.80', name: '볼루토', properties: [-4, 2] },
        { sku: '7853.80', name: '스톡홀름 룽고', properties: [-4, 1] },
        { sku: '7859.80', name: '초콜릿향* 커피', properties: [-2, -4] },
        { sku: '7862.80', name: '아르페지오 디카페나토', properties: [2, 2] },
        { sku: '7892.80', name: '키아로', properties: [-2, 2] },
        { sku: '7856.80', name: '니카라과', properties: [-3, 1] },
        { sku: '7860.80', name: '캐러멜향* 커피', properties: [-3, -4] },
        { sku: '7879.80', name: '비엔나 룽고', properties: [-2, -2] },
        { sku: '7882.80', name: '파리', properties: [-2, -1] },
        { sku: '7870.80', name: '프레도 델리카토', properties: [4, -1] },
        { sku: '7877.80', name: '이스탄불', properties: [2, -1] },
        { sku: '7895.80', name: '나폴리', properties: [5, -3] },
        { sku: '7855.80', name: '리반토', properties: [-2, -3] },
        { sku: '7889.80', name: '콜롬비아', properties: [-2, 3] },
        { sku: '7891.80', name: '스쿠로', properties: [3, -3] },
        { sku: '7888.80', name: '아르페지오', properties: [2, 2] },
        { sku: '7858.80', name: '헤이즐넛향* 커피', properties: [-2, -5] },
        { sku: '7868.80', name: '카자르', properties: [4, -2] },
        { sku: '7857.80', name: '리스트레토 디카페나토', properties: [3, 3] },
        { sku: '7881.80', name: '도쿄 룽고', properties: [-2, 4] },
        { sku: '7890.80', name: '베네치아', properties: [1, -3] },
        { sku: '7861.80', name: '로마', properties: [1, 3] },
        { sku: '7874.80', name: '인도네시아', properties: [1, 2] },
        { sku: '7885.80', name: '리스트레토', properties: [3, 3] },
        { sku: '7887.80', name: '케이프타운 룽고', properties: [3, -4] },
    ],
    vl: [
        { sku: '7063.60', name: '비비다', properties: [-2, -2] },
        { sku: '7066.60', name: '진생 딜라이트', properties: [-3, 1] },
        { sku: '7000.60', name: '알티시오 디카페나토', properties: [4, -1] },
        { sku: '7002.60', name: '비앙코 피콜로 포 밀크', properties: [1, -3] },
        { sku: '7013.60', name: '아론디오', properties: [-1, 1] },
        { sku: '7014.60', name: '이니지오', properties: [-4, 3] },
        { sku: '7015.60', name: '포르타도 디카페나토 ', properties: [-1, 3] },
        { sku: '7016.60', name: '비앙코 도피오 포 밀크', properties: [-4, -1] },
        { sku: '7017.60', name: '에티오피아', properties: [4, -4] },
        { sku: '7023.60', name: '멜로지오 디카페나토', properties: [-1, -2] },
        { sku: '7024.60', name: '솔레리오', properties: [-5, 3] },
        { sku: '7025.60', name: '하프 카페나토', properties: [-3, -1] },
        { sku: '7026.60', name: '멕시코', properties: [2, -1] },
        { sku: '7027.60', name: '엘살바도르', properties: [-3, 4] },
        { sku: '7028.60', name: '콜롬비아', properties: [2, -2] },
        { sku: '7030.60', name: '비앙코 포르테 포 밀크', properties: [-4, 2] },
        { sku: '7039.60', name: '멜로지오', properties: [-2, -1] },
        { sku: '7040.60', name: '스토미오', properties: [3, -2] },
        { sku: '7041.60', name: '오다치오', properties: [2, 1] },
        { sku: '7042.60', name: '인텐소', properties: [4, -3] },
        { sku: '7043.60', name: '코스타리카', properties: [-1, -1] },
        { sku: '7044.60', name: '더블 에스프레소 돌체', properties: [2, -3] },
        { sku: '7047.60', name: '볼테소', properties: [4, -5] },
        { sku: '7060.60', name: '일카페', properties: [5, -2] },
        { sku: '7048.60', name: '알티시오', properties: [4, -1] },
        { sku: '7049.60', name: '디아볼리토', properties: [4, -2] },
        { sku: '7050.60', name: '더블 에스프레소 키아로', properties: [1, 3] },
        { sku: '7058.60', name: '더블 에스프레소 스쿠로', properties: [-3, 5] },
        { sku: '7059.60', name: '포르타도', properties: [3, -1] },
        { sku: '7292.60', name: '스위트 바닐라향* 커피', properties: [-3, -4] },
        { sku: '7294.60', name: '로스티드 헤이즐넛향* 커피', properties: [-4, -2] },
        { sku: '7295.60', name: '골든 캐러멜향* 커피', properties: [-4, -4] },
        { sku: '7296.60', name: '리치 초콜릿향* 커피', properties: [-3, -2] },
        { sku: '7018.60', name: '아이스 레제로', properties: [-2, 4] },
        { sku: '7057.60', name: '스위트 바닐라향* 디카페나토', properties: [-3, -4] },
        { sku: '7029.60', name: '아이스 포르테', properties: [2, -3] },
        { sku: '7192.60', name: '액티브', properties: [-3, -2] },
        { sku: '7010.60', name: '리스트레토 클라시코', properties: [2, 4] },
        { sku: '7133.91', name: '스타벅스® 베란다 블렌드', properties: [3, -2] },
        { sku: '2116.91', name: '스타벅스® 크리미 바닐라향 커피', properties: [-3, -3] },
        { sku: '2117.91', name: '스타벅스® 스무스 캐러멜향 커피', properties: [-4, -3] },
